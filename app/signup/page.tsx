...
export default function SignupPage({ searchParams }: { searchParams: { next?: string; error?: string } }) {
  return (
    <div className="relative flex min-h-[calc(100vh-64px)] items-center justify-center overflow-hidden px-5 py-12">
      ...
      <AuthCard mode="signup" next={searchParams.next} oauthError={searchParams.error} />
    </div>
  );
}
